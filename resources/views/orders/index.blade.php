  ...
  @section('admincontent')
    <div class="p-6" x-data="{ isOpenAddModal: @if ($errors->any()) true @else false @endif }">
      ...
      <form action="/admin/users" method="POST">
        <x-tailwind.modals objectNameParam="User">
        @section('modalcontent')
          ...
          <div class="pb-5">
            <div class="col-span-6">
              ...
              <select id="countries" name="role" class="mt-1 border border-gray-300 text-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
