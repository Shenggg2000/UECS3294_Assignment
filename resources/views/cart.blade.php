                        ...
                        <div class="col-span-2 p-5">
                            ...
                            <div class="flex justify-between items-center mt-6 pt-6">
                                <div class="flex items-center"> <img src="https://i.imgur.com/EEguU02.jpg" width="60" class="rounded-full ">
                                    <div class="flex flex-col ml-3"> <span class="md:text-md font-medium">{{ $cart['name'] }}</span></div>
                                </div>
                                <div class="flex justify-center items-center place-content-center">
                                    <div class="pr-8 flex ">
                                        ...
                                        <input type="text" class="focus:outline-none bg-gray-100 border h-6 w-8 rounded text-sm px-2 mx-2" value={{ $cart['quantity'] }} name="quantity"> 
                                    ...
                                    <div class="flex ">
                                        <div class="pr-8 "> <span class="text-xs font-medium place-content-center">RM {{ $cart['price'] * $cart['quantity'] }}</span>
                            ...
                            <div class="flex justify-between items-center mt-6 pt-6 border-t">
                                <div class="flex items-center"> <i class="fa fa-arrow-left text-sm pr-2"></i> <span class="text-md font-medium text-blue-500"><a href="/groceries/all">Continue Shopping</a></span> </div>
                                <div class="flex justify-center items-end"> <span class="text-sm font-medium text-gray-400 mr-1">Total:</span> <span class="text-lg font-bold text-gray-800 ">RM {{ $totalAmount }}</span> </div>
                            </div>
                            <div class="flex justify-center items-end ">
                                ...
                                <form action="{{ url('/checkout') }}" method="POST">
                                    ...
                                    <button class="nline-block px-6 py-2.5 bg-red-500 text-black font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">CheckOut</button>
                                </form>
                                @else
